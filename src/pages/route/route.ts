...
export class RoutePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private geolocation: Geolocation, private platform: Platform, private toastCtrl: ToastController) {
...
map.addListener('click', function(e) {
 placeMarker(mapLocation,e.latLng,map);
});
...
function placeMarker(point1, point2, map) {
         var marker2 = new google.maps.Marker({
          position: point2,
          map: map
        });

        setRoute(point1,point2,map);

        }

      function setRoute(point1, point2, map){
      ...
      console.log(directionsDisplay.setPanel)
